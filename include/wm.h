...
enum {
  ...
  WM_ACTION_FOCUS_DESKTOP_3,
  WM_ACTION_FOCUS_DESKTOP_4,
  WM_ACTION_FOCUS_DESKTOP_5,
  WM_ACTION_FOCUS_DESKTOP_6,
  WM_ACTION_FOCUS_DESKTOP_7,
  WM_ACTION_FOCUS_DESKTOP_8,
  WM_ACTION_FOCUS_DESKTOP_9,
};
